 ...
 */
@Rule
public class FullCallbackRule extends AbstractCallbackRule {

    public FullCallbackRule() {
        super(WhenEnum.ACCEPT);
    }

    @When
    public WhenEnum when(@Callback SimpleCallback1 simpleCallback1, @Callback SimpleCallback2 simpleCallback2) {
    ...
    @Then
    public void then(@Callback SimpleCallback1 simpleCallback1, @Callback SimpleCallback2 simpleCallback2) {
