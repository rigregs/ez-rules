 ...
 */
@Rule
public class FullCallbackWithMissingAnnotationRule extends AbstractCallbackRule {

    public FullCallbackWithMissingAnnotationRule() {
        super(WhenEnum.ACCEPT);
    }

    @When
    public WhenEnum when(SimpleCallback1 simpleCallback1, SimpleCallback2 simpleCallback2) {
    ...
    @Then
    public void then(SimpleCallback1 simpleCallback1, SimpleCallback2 simpleCallback2) {
