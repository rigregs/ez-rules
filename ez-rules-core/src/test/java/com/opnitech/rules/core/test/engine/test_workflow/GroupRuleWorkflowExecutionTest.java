...
public class GroupRuleWorkflowExecutionTest {
    ...
    @Test
    public void testTestStopFirstGroupDefinition() throws Exception {
    ...
    @Test
    public void testExecuteAllNotExecutedGroupDefinition() throws Exception {
    ...
    @Test
    public void testExecuteAllExecutedGroupDefinition() throws Exception {
    ...
    private void testExecuteAllGroupDefinition(RegisterexecutableCallback callback) throws Exception {
